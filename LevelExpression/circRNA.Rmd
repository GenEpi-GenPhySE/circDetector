...
ggplot(dataframe, aes(x=as.numeric(dataframe$linear), y=as.numeric(dataframe$readc), color = ! is.na(dataframe$circ))) +
  ...
  geom_smooth(method=lm, se=FALSE, fullrange=TRUE) + 
    labs(title=title, x = "TotalRNAseq expression level", y = "mRNAseq expressino level") +
  ...
  scale_color_manual(values=c('dodgerblue2','saddlebrown')) 
  # + scale_fill_discrete(name = "Test", labels = c("A", "B"))
}

ggp_1 = ggp(dataframe = df_ssc_1, "ssc_testis_1")
ggp_2 = ggp(dataframe = df_ssc_2, "ssc_testis_2")
ggp_3 = ggp(dataframe = df_ssc_3, "ssc_testis_3")
