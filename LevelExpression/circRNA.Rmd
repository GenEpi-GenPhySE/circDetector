...
# nrow(df_linear) # 26676
# nrow(df_readcount) # 25880
commom_gene_ids = intersect(df_linear$gene_id, df_readcount$gene_id)
# length(commom_gene_ids) # 17618
```
...
df_ssc_1 = df_tot[, c("gene_id", "ssc_testis_1_linear", "ssc_testis_1_readc", "ssc_testis_1_circ")]
colnames(df_ssc_1)<- c("gene_id", "linear","readc", "circ")
df_ssc_1 = df_ssc_1[ df_ssc_1$gene_id %in% commom_gene_ids, ]

df_ssc_2 = df_tot[, c("gene_id", "ssc_testis_2_linear", "ssc_testis_2_readc", "ssc_testis_2_circ")]
colnames(df_ssc_2)<- c("gene_id", "linear","readc", "circ")
df_ssc_2 = df_ssc_2[ df_ssc_2$gene_id %in% commom_gene_ids, ]

df_ssc_3 = df_tot[, c("gene_id", "ssc_testis_3_linear", "ssc_testis_3_readc", "ssc_testis_3_circ")]
colnames(df_ssc_3)<- c("gene_id", "linear","readc", "circ")
...
ggplot(dataframe, aes(x=as.numeric(linear), y=as.numeric(readc))) +
  ...
  scale_color_manual(values=c('saddlebrown', 'dodgerblue2'), name="Genes",
